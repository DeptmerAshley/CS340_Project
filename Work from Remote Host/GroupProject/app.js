...
PORT        = 3697;                 // Set a port number at the top so it's easy to change in the future
...
app.post('/add-coach-ajax', function(req, res) 
{
    ...
    query1 = `INSERT INTO Coaches (name, email, trainingComplete) VALUES ('${data.name}', '${data.email}', ${trainingComplete})`;
